...
(function ($) {
    $.fn.date = function (options, Ycallback, Ncallback) {
        ...
        $.fn.date.defaultOptions = {
            ...
            theme: "date",                    //控件样式（1：ss日期，2：日期+时间）
            mode: null,                       //操作模式（滑动模式）
        ...
        function bindButton() {
            ...
            $("#dateconfirm").unbind('click').click(function () {
                ...
                //console.log($("#monthwrapper ul li:eq("+indexM+")").html().substr(0,$("#monthwrapper ul li:eq("+indexM+")").html().length-1));
                //console.log(indexD);
        ...
        function init_iScrll() {
            ...
            dayScroll = new iScroll("daywrapper", {
                ...
                onScrollEnd: function () {
                    obj_sc = this;
                    setTimeout(function () { indexD = (obj_sc.y / 40) * (-1) + 1; }, 50);
                }
            });
        }
