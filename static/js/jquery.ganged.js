;(function($){
	...
	function handleData(datas){
		...
		var tempCities = [];
		var tempAreas = [];
		var reProvince=/^[1-9]{2}$/;//省的格式:前2位为'01~99'，后4位为'0000'  例：010000
		var reCity = /^([1-9]{2})|([1-9]{4})$/;//城市的格式:前2位为'01~99',中间2位'01~99',后2位为'00' 例:010100
		var reArea=/^[1-9]{6}$/;//区的格式:前2位为'01~99',中间2位'01~99',后2位为'01~99' 例:010101
		...
		for (var i = 0; i < datas.length; i++) {
			...
			else if (reProvince.test(tempArr[2])) {
