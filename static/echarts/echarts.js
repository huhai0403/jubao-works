...
function (e) {
    ...
    return e
}), define("echarts/echarts", ["require", "./config", "zrender/tool/util", "zrender/tool/event", "zrender/tool/env", "zrender", "zrender/config", "./chart/island", "./component/toolbox", "./component", "./component/title", "./component/tooltip", "./component/legend", "./util/ecData", "./chart", "zrender/tool/color", "./component/timeline", "zrender/shape/Image", "zrender/loadingEffect/Bar", "zrender/loadingEffect/Bubble", "zrender/loadingEffect/DynamicLine", "zrender/loadingEffect/Ring", "zrender/loadingEffect/Spin", "zrender/loadingEffect/Whirling", "./theme/blue", "./theme/dark", "./theme/default", "./theme/gray", "./theme/green", "./theme/helianthus", "./theme/infographic", "./theme/macarons", "./theme/macarons2", "./theme/mint", "./theme/red", "./theme/roma", "./theme/sakura", "./theme/shine"], function (e) {
    function t() {
    ...
    s.version = "2.2.2", s.dependencies = {
        zrender: "2.0.8"
    }, s.init = function (t, n) {
        var a = e("zrender");
    ...
    return i.prototype = {
        ...
        addData: function (e, t, i, n, r) {
            ...
            for (var l = e instanceof Array ? e : [
				[e, t, i, n, r]
            ], h = this.getOption(), d = this._optionRestore, c = 0, m = l.length; m > c; c++) {
                ...
                if (p) {
                    ...
                    if (U[u](t), g[u](t), n || (U[V](), t = g[V]()), null != r) {
                        ...
                        if (p.type === a.CHART_TYPE_PIE && (f = d.legend) && (y = f.data)) {
                            var b = h.legend.data;
                            if (y[u](r), b[u](r), !n) {
                                var _ = o.indexOf(y, t.name); -1 != _ && y.splice(_, 1), _ = o.indexOf(b, t.name), -1 != _ && b.splice(_, 1)
                            }
    ...
    function o() {
        if (!c) if (e("../dep/excanvas"), window.G_vmlCanvasManager) {
            var t = document.createElement("div");
            t.style.position = "absolute", t.style.top = "-1000px", document.body.appendChild(t), c = G_vmlCanvasManager.initElement(t).getContext("2d")
        } else c = document.createElement("canvas").getContext("2d");

        return c
    }

    function r() {
        return p || (m = document.createElement("canvas"), u = m.width, V = m.height, p = m.getContext("2d")), p
    }

    function s(e, t) {
        var i, n = 100;
        e + f > u && (u = e + f + n, m.width = u, i = !0), t + y > V && (V = t + y + n, m.height = V, i = !0), -f > e && (f = Math.ceil(-e / n) * n, u += f, m.width = u, i = !0), -y > t && (y = Math.ceil(-t / n) * n, V += y, m.height = V, i = !0), i && p.translate(f, y)
    }
    ...
    var c = function (i, n) {
        this.id = i, this.env = e("./tool/env"), this.storage = new s, this.painter = new r(n, this.storage), this.handler = new o(n, this.storage, this.painter), this.animatingElements = [], this.animation = new l({
            stage: {
                update: t(this)
            }
    ...
    return c.prototype.getId = function () {
        ...
        if ("string" == typeof e && (e = this.storage.get(e)), e) {
            ...
            var c = e.__animators;
            0 === c.length && d.push(e);
            var m = this.animation.animate(o, {
                loop: a
            }).done(function () {
                var t = i.indexOf(e.__animators, m);
                if (t >= 0 && c.splice(t, 1), 0 === c.length) {
                    var t = i.indexOf(d, e);
                    d.splice(t, 1)
                }
            });
                    ...
                    if (d) if (c) {
                        ...
                        switch (d.type) {
                            ...
                            case s.CHART_TYPE_TREEMAP:
                                if (null == this.component.xAxis || null == this.component.yAxis || r.data.length <= m) return;
                                var p = r.xAxisIndex || 0,
                                    u = r.yAxisIndex || 0;
                                this._event = this.component.xAxis.getAxis(p).type === s.COMPONENT_TYPE_AXIS_CATEGORY ? {
                                    zrenderX: this.component.xAxis.getAxis(p).getCoordByIndex(m),
                                    ...
                                    zrenderY: this.component.yAxis.getAxis(u).getCoordByIndex(m)
                                }, this._showAxisTrigger(p, u, m);
                                break;
                            case s.CHART_TYPE_RADAR:
                                if (null == this.component.polar || r.data[0].value.length <= m) return;
                                var V = r.polarIndex || 0,
                                    U = this.component.polar.getVector(V, m, "max");
                                this._event = {
                                    zrenderX: U[0],
                                    zrenderY: U[1]
                                }, this._showPolarTrigger(V, m)
                        }
                    } else {
                        var g, f, y = d.shapeList;
                        switch (d.type) {
                            case s.CHART_TYPE_LINE:
                            case s.CHART_TYPE_BAR:
                            case s.CHART_TYPE_K:
                            ...
                            case s.CHART_TYPE_SCATTER:
                                for (var m = e.dataIndex, a = 0, o = y.length; o > a; a++) if (null == y[a]._mark && l.get(y[a], "seriesIndex") == t && l.get(y[a], "dataIndex") == m) {
                                    this._curTarget = y[a], g = y[a].style.x, f = d.type != s.CHART_TYPE_K ? y[a].style.y : y[a].style.y[0];
                                    break
                                }
                                break;
                            case s.CHART_TYPE_RADAR:
                                for (var m = e.dataIndex, a = 0, o = y.length; o > a; a++) if ("polygon" === y[a].type && l.get(y[a], "seriesIndex") == t && l.get(y[a], "dataIndex") == m) {
                                    this._curTarget = y[a];
                            ...
                            case s.CHART_TYPE_PIE:
                                for (var b = e.name, a = 0, o = y.length; o > a; a++) if ("sector" === y[a].type && l.get(y[a], "seriesIndex") == t && l.get(y[a], "name") == b) {
                                    this._curTarget = y[a];
                                    var _ = this._curTarget.style,
                                        x = (_.startAngle + _.endAngle) / 2 * Math.PI / 180;
                                    g = this._curTarget.style.x + Math.cos(x) * _.r / 1.5, f = this._curTarget.style.y - Math.sin(x) * _.r / 1.5;
                                    break
                                }
                                break;
                            case s.CHART_TYPE_MAP:
                                for (var b = e.name, k = r.mapType, a = 0, o = y.length; o > a; a++) if ("text" === y[a].type && y[a]._mapType === k && y[a].style._name === b) {
                                    this._curTarget = y[a], g = this._curTarget.style.x + this._curTarget.position[0], f = this._curTarget.style.y + this._curTarget.position[1];
                                    break
                                }
                                break;
                            case s.CHART_TYPE_CHORD:
                                for (var b = e.name, a = 0, o = y.length; o > a; a++) if ("sector" === y[a].type && l.get(y[a], "name") == b) {
                                    this._curTarget = y[a];
                                    var _ = this._curTarget.style,
                                        x = (_.startAngle + _.endAngle) / 2 * Math.PI / 180;
                                    return g = this._curTarget.style.x + Math.cos(x) * (_.r - 2), f = this._curTarget.style.y - Math.sin(x) * (_.r - 2), void this.zr.trigger(h.EVENT.MOUSEMOVE, {
                                        zrenderX: g,
                                        zrenderY: f
                                    })
                                }
                            ...
                            case s.CHART_TYPE_FORCE:
                                for (var b = e.name, a = 0, o = y.length; o > a; a++) if ("circle" === y[a].type && l.get(y[a], "name") == b) {
                                    this._curTarget = y[a], g = this._curTarget.position[0], f = this._curTarget.position[1];
                                    break
                                }
                        }
                        null != g && null != f && (this._event = {
                            zrenderX: g,
                            zrenderY: f
    ...
    var theme = {
        ...
        // 默认色板
        color: ['#44B7D3', '#E42B6D', '#F4E24E', '#FE9616', '#8AED35', '#ff69b4', '#ba55d3', '#cd5c5c', '#ffa500', '#40e0d0', '#E95569', '#ff6347', '#7b68ee', '#00fa9a', '#ffd700', '#6699FF', '#ff6666', '#3cb371', '#b8860b', '#30e0e0'],
    ...
    // 默认色板
    color: ['#ed9678', '#e7dac9', '#cb8e85', '#f3f39d', '#c8e49c', '#f16d7a', '#f3d999', '#d3758f', '#dcc392', '#2e4783', '#82b6e9', '#ff6347', '#a092f1', '#0a915d', '#eaf889', '#6699FF', '#ff6666', '#3cb371', '#d5b158', '#38b6b6'],
    ...
    color: ['#E01F54', '#b8d2c7', '#f5e8c8', '#001852', '#c6b38e', '#a4d8c2', '#f3d999', '#d3758f', '#dcc392', '#2e4783', '#82b6e9', '#ff6347', '#a092f1', '#0a915d', '#eaf889', '#6699FF', '#ff6666', '#3cb371', '#d5b158', '#38b6b6'],
    dataRange: {
        color: ['#e01f54', '#e7dbc3'],
        textStyle: {
            color: '#333'
	...
	function () {
	    ...
	    function k(e, t, i, n) {
	        ...
	        if (a instanceof w) {
	            ...
	            for (var L = k.length, W = k[0].color, I = k[L - 1].color, K = k[0].alpha * e.globalAlpha, S = k[L - 1].alpha * e.globalAlpha, T = [], E = 0; L > E; E++) {
	                var z = k[E];
				    ...
				    if (U) {
				        ...
				        if (U) {
				            ...
				            var z = function (e, o) {
				                ...
				                var d = x[v + 1] - x[v];
				                if (0 !== d) {
				                    if (w = (o - x[v]) / d, m) if (I = k[v], X = k[0 === v ? v : v - 1], K = k[v > U - 2 ? U - 1 : v + 1], S = k[v > U - 3 ? U - 1 : v + 2], f) r(X, I, K, S, w, w * w, w * w * w, l(e, V), b);
				                    else {
				                        var c;
				                        y ? (c = r(X, I, K, S, w, w * w, w * w * w, E, 1), c = h(E)) : c = s(X, I, K, S, w, w * w, w * w * w), i(e, V, c)
            ...
            switch (k.command) {
                ...
                case "A":
                    var L = v[0],
                        ...
                        S = Math.cos(I) * w + L,
                        C = Math.sin(I) * X + W;
                    V ? (V = !1, m = S, p = C) : o += U(d, c, S, C);
                    var T = (n - L) * X / w + L;
                    if (g && h(L, W, X, I, I + K, 1 - v[7], t, T, a)) return !0;
                    _ && (o += b(L, W, X, I, I + K, 1 - v[7], T, a)), d = Math.cos(I + K) * w + L, c = Math.sin(I + K) * X + W;
                    break;
                case "z":
    ...
    function x(e, t) {
        ...
        return v.restore(), w[i] = n, ++I > S && (I = 0, w = {}), n
    }
    ...
    function k(e, t) {
        ...
        return v.restore(), X[i] = n, ++K > S && (K = 0, X = {}), n
    }
    var v, L = e("./util"),
		W = e("./curve"),
		w = {},
    ...
    return i.prototype = {
            ...
            return function (i, n) {
                ...
                for (var w = [], g = 0, X = m.length; X > g; g++) {
                    var I = m[g],
						...
						S = this.getMarkLineShape(n, i, f, g, I.points, L, K.color);
                    S._mark = "line";
                    var C = this.deepMerge([f[0], f[1], n], "effect");
                    C.show && (S.effect = C, S.effect.large = n.large), a.type === h.CHART_TYPE_MAP && (S._geo = [this.getMarkGeo(f[0]), this.getMarkGeo(f[1])]), d.pack(S, a, i, f[0], g, f[0].name + ("" !== f[1].name ? " > " + f[1].name : ""), x), w.push(S)
                }
                return w
            }
        }(),
        ...
        _getAnimationKey: function (e) {
            return this.type != h.CHART_TYPE_MAP && this.type != h.CHART_TYPE_TREEMAP && this.type != h.CHART_TYPE_VENN ? d.get(e, "seriesIndex") + "_" + d.get(e, "dataIndex") + (e._mark ? e._mark : "") + (this.type === h.CHART_TYPE_RADAR ? d.get(e, "special") : "") : d.get(e, "seriesIndex") + "_" + d.get(e, "dataIndex") + (e._mark ? e._mark : "undefined")
        },
    ...
    function o(n, a, o) {
        ...
        return s = o ? X(s) : I(s), !s && (r = 0), ("" + K(s)).length > a && (r += 1, s /= 10), {
            c: s,
            e: r
        }
    }
    ...
    function n() {
        p = U.logLabelBase, null == p ? (u = "plain", p = 10, V = K) : (p = +p, 1 > p && (p = 10), u = "exponent", V = v(p)), g = U.splitNumber, null == g && (g = E);
