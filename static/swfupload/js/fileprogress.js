...
function FileProgress(file, targetid)
{
    ...
    if (!this.fileProgressElement)
    {
        ...
        //
//        this.fileSum = document.createElement("span");
//        this.fileSum.className = swfu.settings.custom_settings.file_count_css;
//        //this.percentSpan.style.marginTop = "10px";
//        this.fileSum.innerHTML = "";
//        this.fileProgressElement.appendChild(this.fileSum);
...
//
//FileProgress.prototype.setFileSum=function(count)
//{
//        this.fileSum.innerHTML=formatUnits(count);
//}
/*
上传完成
*/
