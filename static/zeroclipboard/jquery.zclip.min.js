...
var ZeroClipboard = {
    ...
    $: function (a) {
        if (typeof (a) == "string") {
            ...
            a.removeClass = function (d) {
                ...
                var b = -1; for (var c = 0; c < e.length; c++) {
                    if (e[c] == d) { b = c; c = e.length }
                } if (b > -1) { e.splice(b, 1); this.className = e.join(" ") } return this
            };
    ...
    dispatch: function (d, b, c) {
        var a = this.clients[d]; if (a) { a.receiveEvent(b, c) }
    },
    register: function (b, a) {
        ...
        if (c && (c != a)) {
            b.left += c.offsetLeft; b.top += c.offsetTop
        } return b
    },
    Client: function (a) {
        this.handlers = {};
...
ZeroClipboard.Client.prototype = {
    ...
    glue: function (d, b, e) {
        ...
        var c = ""; var b = "id=" + this.id + "&width=" + d + "&height=" + a;
        ...
        switch (d) {
            case "load":
                ...
                if (!this.ready && navigator.userAgent.match(/Firefox/) && navigator.userAgent.match(/Windows/)) {
                    var c = this; setTimeout(function () { c.receiveEvent("load", null) }, 100); this.ready = true; return
                }
                this.ready = true;
