...
UE.I18N['en'] = {
    'labelMap':{
        ...
        'insertvideo':'Video','insertaudio':'Audio', 'help':'Help', 'justifyleft':'JustifyLeft', 'justifyright':'JustifyRight', 'justifycenter':'JustifyCenter',
    ...
    'insertAudio': {
        'static': {
            ...
            'lang_tab_uploadV': "Upload",
            'lang_Audio_url': " URL ",
            'lang_Audio_size': "Audio Size",
            'lang_AudioW': "Width",
            'lang_AudioH': "Height",
            'lang_alignment': "Alignment",
            'AudioSearchTxt': { 'value': "Enter the search keyword!" },
            'AudioType': { 'options': ["All", "Hot", "Entertainment", "Funny", "Sports", "Science", "variety"] },
            'AudioSearchBtn': { 'value': "Search in Baidu" },
            'AudioSearchReset': { 'value': "Clear result" },

            'lang_input_fileStatus': ' No file uploaded!',
            'startUpload': { 'style': "background:url(upload.png) no-repeat;" },

            'lang_upload_size': "Audio Size",
            'lang_upload_width': "Width",
            'lang_upload_height': "Height",
            'lang_upload_alignment': "Alignment",
            'lang_format_advice': "Recommends mp3 format."
        },
        'numError': "Please enter the correct Num. e.g 123,400",
        'floatLeft': "Float left",
        'floatRight': "Float right",
        ...
        'loading': " &nbsp;The Audio is loading, please wait…",
        'clickToSelect': "Click to select",
        'goToSource': 'Visit source Audio ',
        'noAudio': " &nbsp; &nbsp;Sorry,can't find the Audio,please try again!",
