...
(function(){
    ...
    function convert_url(url){
        ...
        if (url.indexOf(".swf")==-1) {
            return this.editor.options.UEDITOR_HOME_URL + "dialogs/video/ckplayer/ckplayer.swf?f=" + url + "&c=0&b=1";
        }
        return url;
    }
    ...
    function createPreviewVideo(url){
        ...
        '<embed class="previewVideo" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"' +
            ...
            ' width="' + 420  + '"' +
            ' height="' + 280  + '"' +
            ' wmode="transparent" bgcolor="#FFF"  allowScriptAccess="always" allowFullScreen="true" >' +
        '</embed>';
    }
