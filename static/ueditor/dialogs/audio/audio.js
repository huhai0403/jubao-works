...
(function(){
        ...
        (function(){
            ...
            if(img && img.className){
                ...
                if(hasFakedClass || hasUploadClass) {
                    ...
                    $G("audioWidth").value = img.width;
                    $G("audioHeight").value = img.height;
    ...
    function insertSingle(){
        var width = $G("audioWidth"),
            height = $G("audioHeight"),
            url=$G('audioUrl').value,
    ...
    function createPreviewaudio(url){
        if ( !url )return;
        $G("preview").innerHTML = 
        '<embed class="previewaudio" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"' +
            ' src="audioplay.swf?file=' + url + '&button=buttons/negative"' +
            ' width="420"' +
            ' height="280"' +
            ' wmode="transparent" play="true" loop="false" menu="false" allowscriptaccess="always" allowfullscreen="true" >' +
        '</embed>';
    }
    ...
    function insertUpload(){
        var audioObjs=[],
            ...
            width = $G('upload_width').value || 30,
            height = $G('upload_height').value || 30,
