...
var url=easyloader.cssbase+easyloader.theme+"/"+_13["css"]
}
_c(url,function(){
_15="loaded";
...
//easyloader的js文件的名字（就是这些代码所在文件的文件名）
var m = src.match(/easyloader\.custom\.js(\W|$)/i);
//此文件所在路径，相对于网站的根目录
var n = src.match(/Scripts\/easyui\/easyloader\.custom\.js(\W|$)/i);
if(m){
easyloader.base=src.substring(0,m.index)
}
//修改拼接css文件目录路径
if (n) {
easyloader.cssbase=src.substring(0, n.index)+"static/easyui/";
}
